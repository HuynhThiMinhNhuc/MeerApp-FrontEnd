...
class _ChoiceLocationTimeState extends State<ChoiceLocationTime> {
  ...
  void initState() {
    ...
    _locationController = TextEditingController(text: "Khu phố 6 thành phố Thủ Đức tp. Hồ Chí Minh");
  }
                    ...
                    Positioned(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          IconButton(
                            icon: const Icon(FontAwesomeIcons.angleRight, color: meerColorBlack,),
                            onPressed: () => {
