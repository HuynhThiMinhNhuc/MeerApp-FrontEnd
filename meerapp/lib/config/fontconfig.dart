...
var kText11RegularHintText =
    fontConfig.copyWith(fontSize: 11.sp, color: meerColorGreyHintText);
var kText11RegularWhite =
    fontConfig.copyWith(fontSize: 11.sp, color: meerColorWhite);
...
var kText13RegularNote = kText13BoldBlack.copyWith(
    fontWeight: FontWeight.normal, color: meerColorGreyNoteText);
var kText13RegularBlack = kText13RegularNote.copyWith(color: meerColorBlack);
var kText13RegularMain = kText13BoldBlack.copyWith(
    fontWeight: FontWeight.normal, color: meerColorMain);
...
var kText15BoldMain = fontConfig.copyWith(
    fontSize: 15.sp, color: meerColorMain, fontWeight: FontWeight.w600);
var kText15RegularMain = kText15BoldMain.copyWith(fontWeight: FontWeight.w300);
var kText15MediumBlack =
    fontConfig.copyWith(fontSize: 15.sp, fontWeight: FontWeight.w500);
...
var kText16BoldBlack = kText16RegularWhite.copyWith(
...
var kText17SemiboldMain = fontConfig.copyWith(
    fontSize: 17.sp, fontWeight: FontWeight.w500, color: meerColorMain);

var ktext17RegularBlack = fontConfig.copyWith(fontSize: 17.sp);
var ktext17RegularGreyText =
    fontConfig.copyWith(fontSize: 17.sp, color: meerColorGreyNoteText);

var kText17RegularRed = ktext17RegularBlack.copyWith(color: meerColorRed);
var kText17BoldBlack =
    kText17SemiboldBlack.copyWith(fontWeight: FontWeight.bold);

var kText18RegularMain =
    fontConfig.copyWith(fontSize: 18.sp, color: meerColorMain);
...
var kText24MeniumBlack =
    fontConfig.copyWith(fontSize: 24.sp, fontWeight: FontWeight.w500);
